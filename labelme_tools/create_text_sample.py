...
def create_zero(count):
    char_list = '0Oo.----~!O@0o#$%0Oo^.&00.00*()0。-----+|/0Oo[]#%$￥0~---！@#oo￥0O%&*OO。[]0Oo'
    lines = ''
...
if __name__ == "__main__":
    ...
    labels_file = '../output/spec_chars.txt'

    total_lines = ''
    total_lines += create_number_1(10000)
    total_lines += create_zero(30000)
    total_lines += create_char(30000)
    total_lines += create_method_1(30000)
